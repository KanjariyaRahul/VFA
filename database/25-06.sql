...
(64, 'Yash Kanajariya', '9909520639', 'Hey Brandon, we’ve stocked our shelves with assorted mint cookie treats for you. Visit your local KookieU store. Hurry! This flavor is for a limited time only.', 'resolved', '2022-05-18'),
(65, 'Rahul Kanajariya', '8200058835', 'They’re supposed to interest and engage your subscribers immediately. There’s no time to beat around the bush — you have a few seconds to catch their attention before they move on. ', 'pending', '2022-06-21'),
(66, 'Abhay Kachhadiya', '9865321245', 'Mr. Chris, your package has been shipped - ETA: 9-10 A.M. on 18th October at your residence. To track your parcel, visit www.trackmypkg.com.', 'active', '2022-06-19');
...
INSERT INTO `crop-event` (`id`, `crop-id`, `seed-id`, `title`, `description`, `day-after-sowing`, `time`) VALUES
...
(1, 34, 'can you listen me?', 'Yes, I can listen you..');
...
INSERT INTO `crop-tracking` (`id`, `crop_id`, `farmer_id`, `seed-id`, `sowing_date`, `farm_area`, `area_type`, `soil`, `water`, `progress`, `time`) VALUES
(23, 34, 1, 12, '2022-06-20', '12', 'vigha', 'arid-dasert-soil', 'canal-water', 0, '2022-06-23 12:28:35'),
(24, 34, 1, 13, '2022-06-13', '56', 'hacter', 'laterite-soil', 'rain-water', 0, '2022-06-23 12:55:08'),
(25, 1, 1, 14, '2022-06-03', '2', 'acre', 'red-soil', 'surface-water', 0, '2022-06-23 13:06:48');
...
(1, 'Hardik Kanajariya', '6353485415', 'hcollege0@gmail.com', 'Gujarat', 'Dwarka', 'Kalyanpur', 'kalyanpur', 361320, 'hardik', '202cb962ac59075b964b07152d234b70', '19:22:27', '2022-06-24'),
(9, 'Rahul Kanajariya', '9638527410', 'gerex73948@tagbert.com', NULL, NULL, NULL, NULL, NULL, 'rahul', '439ed537979d8e831561964dbbbd7413', '00:51:52', '2022-06-25');
...
(14, 'Forest soil.jpg', 'Sending some new updates ', '2022-06-16 10:55:52'),
(16, 'IMG-20210310-WA0001.jpg', 'hello Farmers ', '2022-06-25 00:43:50');
...
INSERT INTO `seeds` (`id`, `crop-id`, `seed-name`, `description`, `duration`, `yield`, `season`, `image`) VALUES
(11, 34, 'test seed 1', 'fastest growing seed ', 2, '120 ', 'ravi', NULL),
(12, 4, 'Paddy seed 11', 'updated to paddy seeds  ', 189, '567', 'zaid', NULL),
(13, 15, 'seed 3 ', 'something', 110, '450', 'kharif', NULL),
(14, 1, 'onion 1', 'this is special ', 35, '556', 'ravi', NULL),
(16, 3, 'Cotton seeds 456', ' something ', 89, '897', 'kharif', 'IMG-20211022-WA0002.jpg'),
(17, 8, 'brocolly seeds ', 'kklflk adfjkld afdklajld ', 76, '7', 'zaid', 'IMG-20211203-WA0005.jpg');
