...
<head>
    ...
    <title>Manage Updates - VFA</title>
    <?php
                            ...
                            <div class="table-responsive table">
                                <table class="table my-0 farmer-filter" id="myTable">
                                    ...
                                    <tbody id="tdata">
                                        ...
                                        <?php
                                        $sql = "SELECT * FROM `recent-updates`";
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td style="text-align: center;">
                                                    <a class="btn btn-danger" href="./script/delete-recent-update.php?id=<?= $row['id'] ?>"><i class="bx bx-trash me-1"></i> Delete</a>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
