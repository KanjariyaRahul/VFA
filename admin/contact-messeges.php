                ...
                <div class="container-fluid">
                    <div class="card shadow">
                        <div class="card-header py-3">
                            <div class="row">
                                <h4 class="col-md text-primary m-0 fw-bold">Contact Messeges</h4>
                                <div class="col-md">
                        ...
                        <div class="card-body">
                            <div class="table-responsive table mt-2" id="dataTable-1" role="grid" aria-describedby="dataTable_info">
                                <table class="table my-0 contact-filter">
                                    <thead>
                                        <tr>
                                            <th>Id</th>
                                            <th>Name</th>
                                                ...
                                                <td style="text-align: center;">
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item" href="./script/update_contact_messeges.php?s=pending&id=<?= $row['id'] ?>">
                                                                <i class="bx bx-edit-alt me-1"></i>
                                                                Set as Pending
                                                            </a>
                                                            <a class="dropdown-item" href="./script/update_contact_messeges.php?s=active&id=<?= $row['id'] ?>">
                                                                <i class="bx bx-edit-alt me-1"></i>
                                                                Set as Active
                                                            </a>
                                                            <a class="dropdown-item" href="./script/update_contact_messeges.php?s=resolved&id=<?= $row['id'] ?>">
                                                                <i class="bx bx-edit-alt me-1"></i>
                                                                Set as Resolved
                                                            </a>
                                                            <a class="dropdown-item" href="./script/update_contact_messeges.php?s=unsolved&id=<?= $row['id'] ?>">
                                                                <i class="bx bx-edit-alt me-1"></i>
                                                                Set as Unsolved
                                                            </a>
                                                            <a class="dropdown-item" href="./script/update_contact_messeges.php?d=true&id=<?= $row['id'] ?>">
