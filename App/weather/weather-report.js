...
window.addEventListener("load", () => {
  ...
  $.get({
    ...
    success: function (data) {
      let address = "http://ip-api.com/json/" + data.ip;
      ...
      $.get({
        ...
        success: function (data) {
          ...
          if(localStorage.getItem("longitude") == null || localStorage.getItem("latitude") == null){
            if(confirm("Unable to get your Location, Please set your Location in settings")){
      ...
      // Getting latitude and longitude usinf Ip address Ends Here
    },
    error: (data)=>{
      console.log(data);    }
  });
  ...
  // Getting Wind Direction Function 
