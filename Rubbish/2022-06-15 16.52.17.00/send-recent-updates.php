                                    ...
                                    <div class="card-body">
                                        <form onsubmit="return false;" id="form">
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-10">
                                                    <textarea id="msg" name="msg" id="basic-default-message" class="form-control" placeholder="Some Updates Here?"></textarea>
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                <label for="formFile" class="col-sm-2 form-label">Select Picture</label>
                                                <input id="img" name="img" class="form-control" type="file" id="formFile" />
                                            </div>
