        ...
        <main>
                ...
                <div class="crop-gallary">
                    ...
                    ?>
                        <div class="crop-item" onClick="reply_click(this.id)" id="<?= $data["id"] ?>">
                            <img class="lozad" data-src="../img/upload/crop/<?= $data["image"] ?>" alt="crop-image">
            ...
            <section class="select-dieses">
                <div class="disease-gallary">
                    <div class="d-item">
                        <img class="lozad" data-src="../img/disease//demo1.jpg" alt="Disease Picture Demo">
                        <h4>Name of disease</h4>
                    </div>
                    <div class="d-item">
                        <img class="lozad" data-src="../img/disease//demo2.jpg" alt="Disease Picture Demo">
                        <h4>Name of disease</h4>
                    </div>
                    <div class="d-item">
                        <img class="lozad" data-src="../img/disease//demo3.jpg" alt="Disease Picture Demo">
                        <h4>Name of disease</h4>
                    </div>
                    <div class="d-item">
                        <img class="lozad" data-src="../img/disease//demo4.jpg" alt="Disease Picture Demo">
                        <h4>Name of disease</h4>
                    </div>
                    <div class="d-item">
                        <img class="lozad" data-src="../img/disease//demo5.jpg" alt="Disease Picture Demo">
                        <h4>Name of disease</h4>
                    </div>
                </div>
            </section>
