                  ...
                  <div class="card-body">
                    <form method="get" action="../script/crop-info.php" id="crop-info-form">
                      ...
                      <div class="row mb-3">
                        ...
                        <div class="col-md-10">
                          <input name="ex-exp" class="form-control" type="text" placeholder="disease title" id="html5-text-input" />
                        </div>
                      </div>
                      <div class="row mb-3">
                        <label class="col-sm-2 col-form-label" for=" ">Expected Harvest</label>
                        <div class="col-sm-10">
                          <textarea name="ex-harvest" class="form-control" placeholder="disease discription"></textarea>
                        </div>
                      </div>
                      <div class="row mb-3">
                        <label class="col-sm-2 col-form-label" for=" ">Expected Income</label>
                        <div class="col-sm-10">
                          <textarea name="ex-inc" class="form-control" placeholder="Disease Symptoms"></textarea>
                        </div>
                      </div>
                      <h3>Favourable</h3>
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                          <textarea name="fav-cli" class="form-control" placeholder="Pesticide Information"></textarea>
                        </div>
                      </div>
                      <div class="row mb-3">
                        <label class="col-sm-2 col-form-label" for=" ">Favourable Temperature</label>
                        <div class="col-sm-10">
                          <textarea name="fav-temp" class="form-control" placeholder="Pesticide Information"></textarea>
                        </div>
                      </div>
                      <div class="row mb-3">
                        <label class="col-sm-2 col-form-label" for=" ">Favourable Water</label>
                        <div class="col-sm-10">
                          <textarea name="fav-water" class="form-control" placeholder="Pesticide Information"></textarea>
                        </div>
                      </div>
                      <h3>Required</h3>
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                          <textarea name="rq-soil-type" class="form-control" placeholder="Pesticide Information"></textarea>
                        </div>
                      </div>
                      <div class="row mb-3">
                      ...
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                          <textarea name="sow-info" class="form-control" placeholder="Pesticide Information"></textarea>
                        </div>
                      </div>
                      ...
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                          <textarea name="lp" class="form-control" placeholder="Pesticide Information"></textarea>
                        </div>
                      </div>
                      ...
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                          <textarea name="sppc" class="form-control" placeholder="Pesticide Information"></textarea>
                        </div>
                      </div>
                      ...
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                          <textarea name="rdt" class="form-control" placeholder="Pesticide Information"></textarea>
                        </div>
                      </div>
                      <h3>Transplanting</h3>
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                          <textarea name="transplant" class="form-control" placeholder="Pesticide Information"></textarea>
                        </div>
                      </div>
                      ...
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                          <textarea name="nm-timely-sow" class="form-control" placeholder="Pesticide Information"></textarea>
                        </div>
                      </div>
                      <div class="row mb-3">
                        <label class="col-sm-2 col-form-label" for=" ">For Irrigated and late sowing</label>
                        <div class="col-sm-10">
                          <textarea name="nm-late-sow" class="form-control" placeholder="Pesticide Information"></textarea>
                        </div>
                      </div>
                      <div class="row mb-3">
                        <label class="col-sm-2 col-form-label" for=" ">For Rainfed Sowing</label>
                        <div class="col-sm-10">
                          <textarea name="nm-rain-sow" class="form-control" placeholder="Pesticide Information"></textarea>
                        </div>
                      </div>
                      ...
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                          <textarea name="irrigation" class="form-control" placeholder="Pesticide Information"></textarea>
                        </div>
                      </div>
                      ...
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                          <textarea name="yield" class="form-control" placeholder="Pesticide Information"></textarea>
                        </div>
                      </div>
