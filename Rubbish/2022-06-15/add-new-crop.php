                    ...
                    <div class="card-body">
                      <form>
                        <div class="row mb-3">
                          ...
                          <div class="col-md-10">
                            <input class="form-control" type="text" placeholder="Brinjal" id="html5-text-input" />
                          </div>
                        </div>
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="basic-default-message">Crop Description</label>
                          <div class="col-sm-10">
                            <textarea id="basic-default-message" class="form-control" placeholder="Some Description Here?"></textarea>
                          </div>
                        </div>
                        <div class="row mb-3">
